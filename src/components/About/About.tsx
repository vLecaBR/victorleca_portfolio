    ...
    <section id="about" className="relative py-32 px-4 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto" ref={ref}>
            ...
            >
              ...
              <div className="relative p-6 md:p-8 bg-black/40 backdrop-blur-sm border border-white/10 rounded-2xl hover:border-cyan-400/50 transition-all duration-500 hover:shadow-xl hover:shadow-cyan-500/10">
                <motion.div
                  ...
                  className="inline-flex items-center justify-center w-14 h-14 mb-4 bg-gradient-to-r from-cyan-400 to-blue-600 rounded-xl"
                >
        ...
        <motion.div
          ...
          className="mt-12 md:mt-16 p-6 md:p-8 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-2xl border border-white/10 backdrop-blur-sm"
        >
